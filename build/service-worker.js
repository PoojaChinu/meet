(() => {
  ...
  async function m(e, t) {
    ...
    if (s !== self.location.origin)
      throw new a("cross-origin-copy-response", { origin: s });
    const n = e.clone(),
      r = {
    ...
    _useDefaultCacheabilityPluginIfNeeded() {
      ...
      for (const [s, n] of this.plugins.entries())
        n !== G.copyRedirectedCacheableResponsesPlugin &&
          (n === G.defaultPrecacheCacheabilityPlugin && (e = s),
          n.cacheWillUpdate && t++);
      0 === t
  ...
  let ee;
  const te = () => (
    ee || ((ee = new Z()), ee.addFetchListener(), ee.addCacheListener()), ee
  );
  function se(e, t, s) {
    let n;
    if ("string" === typeof e) {
  ...
  self.addEventListener("activate", () => self.clients.claim()),
    (function (e) {
      ...
      { revision: "25989f476f71a1412e25cf6d8dbefdc1", url: "/meet/index.html" },
      { revision: null, url: "/meet/static/css/main.e8433431.css" },
      { revision: null, url: "/meet/static/js/453.4a9980c6.chunk.js" },
      { revision: null, url: "/meet/static/js/main.d4ef398a.js" },
    ]),
    (function (e) {
      const t = J();
      se(new ne(t, e));
  ...
  }, ((oe = "/meet/index.html"), J().createHandlerBoundToURL(oe))),
    se(
      (e) => {
        let { url: t } = e;
